package com.u6f6o.apps.hazelnate.application.rest.transformer;

import com.u6f6o.apps.hazelnate.application.domain.City;
import com.u6f6o.apps.hazelnate.application.domain.Country;
import com.u6f6o.apps.hazelnate.application.domain.Inhabitant;
import com.u6f6o.apps.hazelnate.application.domain.Language;
import com.u6f6o.apps.hazelnate.application.rest.model.CityModel;
import com.u6f6o.apps.hazelnate.application.rest.model.CountryModel;
import com.u6f6o.apps.hazelnate.application.rest.model.InhabitantModel;
import com.u6f6o.apps.hazelnate.application.rest.model.LanguageModel;
